...
# WARNING: Ensure imports from `fast_api_project_template` comes after this line
from fast_api_project_template import app, settings, db  # noqa
from fast_api_project_template.cli import create_user, cli  # noqa
