...
- 🎯 Entry points to execute your program using `python -m <fast_api_project_template>` or `$ fast_api_project_template` with basic CLI argument parsing.
...
---
# fast_api_project_template

[![codecov](https://codecov.io/gh/Mdsomratakbor/fast_api_project_template/branch/main/graph/badge.svg?token=fast_api_project_template_token_here)](https://codecov.io/gh/Mdsomratakbor/fast_api_project_template)
[![CI](https://github.com/Mdsomratakbor/fast_api_project_template/actions/workflows/main.yml/badge.svg)](https://github.com/Mdsomratakbor/fast_api_project_template/actions/workflows/main.yml)

Awesome fast_api_project_template created by Mdsomratakbor

## Install

from source
```bash
git clone https://github.com/Mdsomratakbor/fast_api_project_template fast_api_project_template
cd fast_api_project_template
make install
```
...
```bash
pip install fast_api_project_template
```

## Executing

```bash
$ fast_api_project_template run --port 8080
```

or

```bash
python -m fast_api_project_template run --port 8080
```

or

```bash
$ uvicorn fast_api_project_template:app
```

## CLI

```bash
❯ fast_api_project_template --help
Usage: fast_api_project_template [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fast_api_project_template create-user --help
Usage: fast_api_project_template create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fast_api_project_template create-user admin admin --superuser
```
...
```bash
❯ fast_api_project_template shell       
...
Run with `fast_api_project_template run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fast_api_project_template create-user`.
...
-----------------------------------------------------
fast_api_project_template/__init__.py              4      0   100%
fast_api_project_template/app.py                  16      1    94%
fast_api_project_template/cli.py                  21      0   100%
fast_api_project_template/config.py                5      0   100%
fast_api_project_template/db.py                   10      0   100%
fast_api_project_template/models/__init__.py       0      0   100%
fast_api_project_template/models/content.py       47      1    98%
fast_api_project_template/routes/__init__.py      11      0   100%
fast_api_project_template/routes/content.py       52     25    52%
fast_api_project_template/routes/security.py      15      1    93%
fast_api_project_template/routes/user.py          52     26    50%
fast_api_project_template/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fast_api_project_template/default.toml.
